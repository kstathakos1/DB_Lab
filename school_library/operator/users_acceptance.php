...
<head> <!-- Import css and js packages -->
    ...
    <meta charset="UTF-8">
    <title>Users Waiting Acceptance</title>
    <?php
...
where school_id=$school_id and activity='submitted'
                ...
                <div class="col-2">
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="users_acceptance.php">Deactivated </a>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="centered-table">
                <?php if (mysqli_num_rows($result) == 0) { ?>
                    <div>
                        <h2>There Aren't Any Users Waiting Acceptance</h2>
                    </div>
                <?php } else {
                    ?>
