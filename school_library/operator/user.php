...
<div class="container" id="background">
    <div class="row d-flex justify-content-center align-items-center">
        <div class="col-xl-5" style="align-items: center; vertical-align: center;margin-top: 4%">
            <div class="card" style="border-radius: 2rem; margin-top: 0%; margin-bottom: 5%; text-align: center;vertical-align: center;">
                <div class="card-body text-center">
                    ...
                    <div>
                        <button type="button" class="btn btn-outline-dark">
                            <a href="users_rentals.php?username=<?=$user['username']?>" class="text-decoration-none text-reset"> Rented Books by <?php echo $user['first_name'].' '.$user['last_name']?></a>
                        </button>
                    </div>
