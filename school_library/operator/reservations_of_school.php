...
<head> <!-- Import css and js packages -->
    ...
    if (isset($_GET['search'])) {
        $search = $_GET['search'];
        $search='%'.$search.'%';
        $result = $conn->query("SELECT distinct concat(u.first_name,' ',u.last_name) as name, r.ISBN ,b.title, r.reservation_date,r.expiration_date ,u.username
FROM reservation r
...
<div class="container" id="background">
    <div class="container" id="top_bar">
        ...
        <form id="serach" action="reservations_of_school.php?search=" autocomplete="off">
                    ...
                    <table class="table table1" style="margin-top: 0%">
                        ...
                        <?php while ($rental = mysqli_fetch_assoc($result)) { ?>
                            <tr>
                                ...
                                <td><?php echo $rental['reservation_date']; ?></td>
                                <td><?php echo $rental['expiration_date']; ?></td>
